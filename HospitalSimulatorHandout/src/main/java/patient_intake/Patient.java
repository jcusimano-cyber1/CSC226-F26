...
public class Patient extends Person {
    ...
    public void setAge(int age) {
        this.age = age;
        if(age<0){
            System.out.println("This age is not accepted");}
        if(age>120){
            System.out.println("This age is outside the range");}
            }
    ...
    public String toString() {
        return "Patients [ID = " + patientID + " , Name=" + firstName + lastName + ", Age=" + age + ", Condition=" + currentStage + "]" ; // TODO REQUIRED: Return a useful representation of a patient.
    }
}